...
/** @this {Function} */
(shadow.cljs.devtools.client.browser.devtools_msg.cljs$lang$applyTo = (function (seq20741){
var G__20742 = cljs.core.first(seq20741);
var seq20741__$1 = cljs.core.next(seq20741);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20742,seq20741__$1);
}));
...
var seq__20745 = cljs.core.seq(sources);
var chunk__20746 = null;
var count__20747 = (0);
var i__20748 = (0);
while(true){
if((i__20748 < count__20747)){
var map__20756 = chunk__20746.cljs$core$IIndexed$_nth$arity$2(null,i__20748);
...
}catch (e20757){var e_21033 = e20757;
if(shadow.cljs.devtools.client.env.log){
...
var G__21034 = seq__20745;
var G__21035 = chunk__20746;
var G__21036 = count__20747;
var G__21037 = (i__20748 + (1));
seq__20745 = G__21034;
chunk__20746 = G__21035;
count__20747 = G__21036;
i__20748 = G__21037;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__20745);
if(temp__5753__auto__){
var seq__20745__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__20745__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__20745__$1);
var G__21038 = cljs.core.chunk_rest(seq__20745__$1);
var G__21039 = c__4679__auto__;
var G__21040 = cljs.core.count(c__4679__auto__);
var G__21041 = (0);
seq__20745 = G__21038;
chunk__20746 = G__21039;
count__20747 = G__21040;
i__20748 = G__21041;
continue;
} else {
var map__20759 = cljs.core.first(seq__20745__$1);
var map__20759__$1 = cljs.core.__destructure_map(map__20759);
var src = map__20759__$1;
var resource_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"resource-id","resource-id",-1308422582));
var output_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"output-name","output-name",-1769107767));
var resource_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"resource-name","resource-name",2001617100));
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"js","js",1768080579));
$CLJS.SHADOW_ENV.setLoaded(output_name);
...
try{shadow.cljs.devtools.client.browser.script_eval([cljs.core.str.cljs$core$IFn$_invoke$arity$1(js),"\n//# sourceURL=",cljs.core.str.cljs$core$IFn$_invoke$arity$1($CLJS.SHADOW_ENV.scriptBase),cljs.core.str.cljs$core$IFn$_invoke$arity$1(output_name)].join(''));
}catch (e20761){var e_21042 = e20761;
if(shadow.cljs.devtools.client.env.log){
...
var G__21043 = cljs.core.next(seq__20745__$1);
var G__21044 = null;
var G__21045 = (0);
var G__21046 = (0);
seq__20745 = G__21043;
chunk__20746 = G__21044;
count__20747 = G__21045;
i__20748 = G__21046;
continue;
}
} else {
...
var seq__20762 = cljs.core.seq(js_requires);
var chunk__20763 = null;
var count__20764 = (0);
var i__20765 = (0);
while(true){
if((i__20765 < count__20764)){
var js_ns = chunk__20763.cljs$core$IIndexed$_nth$arity$2(null,i__20765);
...
var G__21048 = seq__20762;
var G__21049 = chunk__20763;
var G__21050 = count__20764;
var G__21051 = (i__20765 + (1));
seq__20762 = G__21048;
chunk__20763 = G__21049;
count__20764 = G__21050;
i__20765 = G__21051;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__20762);
if(temp__5753__auto__){
var seq__20762__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__20762__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__20762__$1);
var G__21052 = cljs.core.chunk_rest(seq__20762__$1);
var G__21053 = c__4679__auto__;
var G__21054 = cljs.core.count(c__4679__auto__);
var G__21055 = (0);
seq__20762 = G__21052;
chunk__20763 = G__21053;
count__20764 = G__21054;
i__20765 = G__21055;
continue;
} else {
var js_ns = cljs.core.first(seq__20762__$1);
...
var G__21057 = cljs.core.next(seq__20762__$1);
var G__21058 = null;
var G__21059 = (0);
var G__21060 = (0);
seq__20762 = G__21057;
chunk__20763 = G__21058;
count__20764 = G__21059;
i__20765 = G__21060;
continue;
}
} else {
...
shadow.cljs.devtools.client.browser.handle_build_complete = (function shadow$cljs$devtools$client$browser$handle_build_complete(runtime,p__20767){
var map__20769 = p__20767;
var map__20769__$1 = cljs.core.__destructure_map(map__20769);
var msg = map__20769__$1;
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20769__$1,new cljs.core.Keyword(null,"info","info",-317069002));
var reload_info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20769__$1,new cljs.core.Keyword(null,"reload-info","reload-info",1648088086));
...
var iterys__4648__auto__ = ((function (s__20772__$1,map__20777,map__20777__$1,src,resource_name,warnings,xs__6308__auto__,temp__5753__auto__,map__20769,map__20769__$1,msg,info,reload_info){
return (function shadow$cljs$devtools$client$browser$handle_build_complete_$_iter__20771_$_iter__20773(s__20774){
return (new cljs.core.LazySeq(null,((function (s__20772__$1,map__20777,map__20777__$1,src,resource_name,warnings,xs__6308__auto__,temp__5753__auto__,map__20769,map__20769__$1,msg,info,reload_info){
return (function (){
...
});})(s__20772__$1,map__20777,map__20777__$1,src,resource_name,warnings,xs__6308__auto__,temp__5753__auto__,map__20769,map__20769__$1,msg,info,reload_info))
,null,null));
});})(s__20772__$1,map__20777,map__20777__$1,src,resource_name,warnings,xs__6308__auto__,temp__5753__auto__,map__20769,map__20769__$1,msg,info,reload_info))
;
...
return shadow.cljs.devtools.client.shared.load_sources(runtime,sources_to_get,(function (p1__20766_SHARP_){
return shadow.cljs.devtools.client.browser.do_js_reload(msg,p1__20766_SHARP_,shadow.cljs.devtools.client.hud.load_end_success,shadow.cljs.devtools.client.hud.load_failure);
}));
}
} else {
return null;
