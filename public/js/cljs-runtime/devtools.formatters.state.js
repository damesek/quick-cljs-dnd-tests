...
var i__4865__auto___10889 = (0);
while(true){
if((i__4865__auto___10889 < len__4864__auto___10887)){
args__4870__auto__.push((arguments[i__4865__auto___10889]));

var G__10891 = (i__4865__auto___10889 + (1));
i__4865__auto___10889 = G__10891;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq10869){
var G__10870 = cljs.core.first(seq10869);
var seq10869__$1 = cljs.core.next(seq10869);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10870,seq10869__$1);
}));
...
return cljs.core.some((function (p1__10872_SHARP_){
return (p1__10872_SHARP_ === object);
}),history);
});
