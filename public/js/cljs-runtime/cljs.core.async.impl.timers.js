...
var i_14112 = (self__.level + (1));
while(true){
if((i_14112 <= (new_level + (1)))){
(update[i_14112] = self__.header);

var G__14113 = (i_14112 + (1));
i_14112 = G__14113;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14114 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14114[i]));
} else {
x__$2.forward.push((((i < links_14114.length))?(links_14114[i]):null));
}

if((i < links_14114.length)){
(links_14114[i] = x__$2);
} else {
links_14114.push(x__$2);
}
...
var i_14123 = (0);
while(true){
if((i_14123 <= self__.level)){
var links_14124 = (update[i_14123]).forward;
if((x__$1 === (((i_14123 < links_14124.length))?(links_14124[i_14123]):null))){
(links_14124[i_14123] = (x__$1.forward[i_14123]));

var G__14125 = (i_14123 + (1));
i_14123 = G__14125;
continue;
} else {
var G__14126 = (i_14123 + (1));
i_14123 = G__14126;
continue;
}
} else {
...
var G__14132 = nx;
var G__14133 = (level__$1 - (1));
x = G__14132;
level__$1 = G__14133;
continue;
} else {
var G__14135 = x;
var G__14136 = (level__$1 - (1));
x = G__14135;
level__$1 = G__14136;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14141 = nx;
var G__14142 = (level__$1 - (1));
x = G__14141;
level__$1 = G__14142;
continue;
} else {
var G__14143 = x;
var G__14144 = (level__$1 - (1));
x = G__14143;
level__$1 = G__14144;
continue;
}
