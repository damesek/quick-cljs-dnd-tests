...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10999){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11000,G__11001,seq10999__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11047_SHARP_){
return (!((cljs.core.meta(p1__11047_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11052__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11053){var _e__9878__auto__ = e11053;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e11055){var _e__9878__auto__ = e11055;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11059 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11060 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11060);

try{var map__11061 = opts;
var map__11061__$1 = cljs.core.__destructure_map(map__11061);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11061__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11059);
}});
...
var temp__5751__auto___11081 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___11081)){
var managed_print_level_11082 = temp__5751__auto___11081;
var _STAR_print_level_STAR__orig_val__11065_11083 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11066_11084 = managed_print_level_11082;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11066_11084);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11064_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11064_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11065_11083);
}} else {
job_fn();
}
