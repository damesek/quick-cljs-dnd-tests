...
var G__12322 = o;
reagent.impl.template.goog$module$goog$object.set(G__12322,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12323 = o;
reagent.impl.template.goog$module$goog$object.set(G__12323,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__12324 = props;
var G__12324__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12324,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12324);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12324__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12325 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12325,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12325;
}
})(),id_class);
...
var G__12326 = (cljs.core.count(argv) - first_child);
switch (G__12326) {
case (0):
...
var vec__12327 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12327,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12327,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12327,(2),null);
...
var temp__5757__auto___12353 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___12353 == null)){
} else {
var key_12354 = temp__5757__auto___12353;
(jsprops.key = key_12354);
}
...
var temp__5757__auto___12355 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___12355 == null)){
} else {
var key_12356 = temp__5757__auto___12355;
(jsprops.key = key_12356);
}
...
var temp__5757__auto___12361 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___12361 == null)){
} else {
var key_12362 = temp__5757__auto___12361;
(jsprops.key = key_12362);
}
...
var temp__5757__auto___12368 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___12368 == null)){
} else {
var key_12369 = temp__5757__auto___12368;
(jsprops.key = key_12369);
}
...
var temp__5757__auto___12370 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___12370 == null)){
} else {
var key_12371 = temp__5757__auto___12370;
(jsprops.key = key_12371);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12330_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12330_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12331 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12331,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12331,(1),null);
...
break;
default:
var G__12379 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12380 = compiler;
v = G__12379;
compiler = G__12380;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template12337 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template12337 = (function (opts,id,fn_to_element,meta12338){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12337.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12339,meta12338__$1){
var self__ = this;
var _12339__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12337(self__.opts,self__.id,self__.fn_to_element,meta12338__$1));
}));

(reagent.impl.template.t_reagent$impl$template12337.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12339){
var self__ = this;
var _12339__$1 = this;
return self__.meta12338;
}));

(reagent.impl.template.t_reagent$impl$template12337.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12337.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12337.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12337.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12337.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta12338","meta12338",-1805685787,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12337.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12337.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12337");

(reagent.impl.template.t_reagent$impl$template12337.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template12337");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12337.
 */
reagent.impl.template.__GT_t_reagent$impl$template12337 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template12337(opts__$1,id__$1,fn_to_element__$1,meta12338){
return (new reagent.impl.template.t_reagent$impl$template12337(opts__$1,id__$1,fn_to_element__$1,meta12338));
});

}

return (new reagent.impl.template.t_reagent$impl$template12337(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
