...
if((i < len)){
var k = (ks[i]);
var G__13379 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13380 = (i + (1));
m = G__13379;
i = G__13380;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13282 = c;
var G__13282__$1 = (((G__13282 == null))?null:G__13282.prototype);
if((G__13282__$1 == null)){
return null;
} else {
return (G__13282__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13283 = c;
var G__13283__$1 = (((G__13283 == null))?null:G__13283.prototype);
if((G__13283__$1 == null)){
return null;
} else {
return (G__13283__$1["render"]);
}
})() == null)))));
});
...
var G__13291 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13291) : reagent.impl.component.as_element.call(null,G__13291));
};
...
var _STAR_current_component_STAR__orig_val__13292 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13293 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13293);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13292);
}});
...
var G__13318 = key;
var G__13318__$1 = (((G__13318 instanceof cljs.core.Keyword))?G__13318.fqn:null);
switch (G__13318__$1) {
...
var c = this;
var G__13355_13387 = (c["cljsRatom"]);
if((G__13355_13387 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13355_13387);
}
...
var renders_13389 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_13390 = cljs.core.first(cljs.core.vals(renders_13389));
if((cljs.core.count(renders_13389) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13389))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13390)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13390], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__13363 = name;
switch (G__13363) {
case "":
...
var name = (function (){var G__13365 = fiber;
var G__13365__$1 = (((G__13365 == null))?null:(G__13365["type"]));
if((G__13365__$1 == null)){
return null;
} else {
return (G__13365__$1["displayName"]);
}
})();
var parent = (function (){var G__13366 = fiber;
if((G__13366 == null)){
return null;
} else {
return (G__13366["return"]);
}
})();
var path = (function (){var G__13367 = parent;
var G__13367__$1 = (((G__13367 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__13367) : reagent.impl.component.fiber_component_path.call(null,G__13367)));
if((G__13367__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13367__$1)," > "].join('');
}
})();
...
var temp__5751__auto__ = (function (){var or__4253__auto__ = (function (){var G__13368 = c;
if((G__13368 == null)){
return null;
} else {
return (G__13368["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
return G__13369._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4253__auto__ = (function (){var G__13370 = c;
if((G__13370 == null)){
return null;
} else {
return (G__13370["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var or__4253__auto____$1 = (function (){var G__13371 = c;
if((G__13371 == null)){
return null;
} else {
return G__13371._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4253__auto__ = (function (){var G__13372 = instance;
if((G__13372 == null)){
return null;
} else {
return (G__13372["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__13373 = instance;
if((G__13373 == null)){
return null;
} else {
return G__13373._currentElement;
}
}
})();
var name = (function (){var G__13374 = elem;
var G__13374__$1 = (((G__13374 == null))?null:(G__13374["type"]));
if((G__13374__$1 == null)){
return null;
} else {
return (G__13374__$1["displayName"]);
}
})();
var owner = (function (){var or__4253__auto__ = (function (){var G__13375 = elem;
if((G__13375 == null)){
return null;
} else {
return (G__13375["_owner"]);
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
return G__13376._owner;
}
}
})();
var path = (function (){var G__13377 = owner;
var G__13377__$1 = (((G__13377 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__13377) : reagent.impl.component.component_path.call(null,G__13377)));
if((G__13377__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13377__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__13378 = c;
var G__13378__$1 = (((G__13378 == null))?null:G__13378.constructor);
if((G__13378__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13378__$1);
}
}
})();
